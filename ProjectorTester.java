...
project.brandName="BenQ";
project.hasWiFi="yes";
project.uses="Schools";
project.price=45000.00;
...
project1.brandName="Epson";
project1.hasWiFi="yes";
project1.uses="Conferences";
project1.price=60000.00;
...
Projector project2=new Projector();
project2.brandName="JVC";
project2.hasWiFi="no";
project2.uses="Colleges";
project2.price=12000.75;
...
Projector project3=new Projector();
project3.brandName="Sony";
project3.hasWiFi="yes";
project3.uses="Presentations";
project3.price=69861.00;
...
Projector project4=new Projector();
project4.brandName="ViewSonic";
project4.hasWiFi="yes";
project4.uses="Homes";
project4.price=19651.00;
...
Projector project5=new Projector();
project5.brandName="Samsung";
project5.hasWiFi="yes";
project5.uses="Parties";
project5.price=68000.00;
...
Projector project6=new Projector();
project6.brandName="Acer";
project6.hasWiFi="no";
project6.uses="Threater";
project6.price=20917.00;
...
Projector project7=new Projector();
project7.brandName="Panasonic";
project7.hasWiFi="yes";
project7.uses="Home Threater";
project7.price=51000.20;
...
Projector project8=new Projector();
project8.brandName="InFocus";
project8.hasWiFi="no";
project8.uses="Business";
project8.price=13000.90;
...
Projector project9=new Projector();
project9.brandName="Vivitek";
project9.hasWiFi="yes";
project9.uses="Automobile";
project9.price=89000.99;
